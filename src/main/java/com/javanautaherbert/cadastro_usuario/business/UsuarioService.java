...
public class UsuarioService { //14:31
    ...
    public Usuario buscarUsuarioPorEmail(String email){
        ...
        return repository.findByEmail(email).orElseThrow( //18:35
    ...
    public void atualizarUsuarioPorID(Integer id, Usuario usuario){ //25:41
        Usuario usuarioEntity = repository.findById(id).orElseThrow(() -> new RuntimeException("Usuario não encontrado"));
        //Usuario usuarioEntity = buscarUsuarioPorEmail(email); //22:10
